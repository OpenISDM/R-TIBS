...
namespace NCTU
{
    ...
    [ProvideLanguageExtension(typeof(IronyLanguageService), ".gpl")]
    ...
    [ProvideLoadKey("Standard", "1.0", "Generic Policy Language", "NCTU", 104)]
    [Guid(GuidList.guidIronyLanguageServicePkgString)]
    public sealed class GPL_Language : IronyPackage
    {
        /// <summary>
